...
def generate_campaign_offer(user_data, previous_offers, deployment_name):
    ...
    prompt = (
        ...
        f"Generate Cashback amount as it is suggested from the random_factor and the amount should be % of Transaction amount and generate different output everytime."
    )
    try:
